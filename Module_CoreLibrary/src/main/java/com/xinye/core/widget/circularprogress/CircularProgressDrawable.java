...
public class CircularProgressDrawable extends Drawable implements Animatable {
    ...
    private CircularProgressDrawable(int[] colors, float borderWidth, float sweepSpeed, float rotationSpeed,
    ...
    public static class Builder {
        ...
        public CircularProgressDrawable build() {
            return new CircularProgressDrawable(mColors, mStrokeWidth, mSweepSpeed, mRotationSpeed, mMinSweepAngle,
